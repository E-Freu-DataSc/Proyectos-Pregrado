...
def Definir_remplazar_nulos_y_aplicar_datatime(self):
    ...
    for column in columns_to_update:
        ...
        self.loc[mask & self[column].notnull(), gold_column] = self.loc[mask & self[column].notnull(), column]
        self.loc[mask & self[gold_column].notnull(), column] = self.loc[mask & self[gold_column].notnull(), gold_column]
